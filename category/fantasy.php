...
<header>
    ...
    <article id="category">
        ...
        $records = mysqli_query($conn,"select * from getflix_movies where getflix_movies.genre_id='10751' "); // fetch data from database


        $records = mysqli_query($conn,"select * from getflix_movies where genre_id='10751'"); // fetch data from database
        $i = 1;
